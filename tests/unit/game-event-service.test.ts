...
import {
    GameEventService,
} from "../../src/application/game-event-service/game-event-service.js";
...
} from "../../src/infrastructure/database/in-memory-game-event-repository.js";
...
function createActiveGame(
    ...
    if (
        ...
        throw new Error(
            "Missing objective test fixture.",
        );
    }
...
describe(
    ...
    () => {
        it(
            "rebuilds objective progress from verified game events",
            async () => {
                const {
                    service,
                    gameRepository,
        ...
        it(
            "does not apply a pending event until it is verified",
            async () => {
                const {
                    service,
                    gameRepository,
        ...
        it(
            "rejects events referencing a player outside the game",
            async () => {
                const {
                    service,
                } =
                ...
                await expect(
                    ...
                    "Game event references unknown actor player: eve",
                );
            },
        );
    },
