...
describe(
    ...
    () => {
        it(
            "records a verified potion event for the reporter",
            async () => {
                const {
                    service,
                } =
        ...
        it(
            "records block amount and target",
            async () => {
                const {
                    service,
                } =
        ...
        it(
            "marks a reported dead player as dead",
            async () => {
                const {
                    service,
                    gameRepository,
        ...
        it(
            "advances to act 2 and assigns new secondary objectives",
            async () => {
                const {
                    service,
                    gameRepository,
        ...
        it(
            "rejects manual reports in STS2 mode",
            async () => {
                const {
                    service,
                } =
        ...
        it(
            "only allows the host to report act completion",
            async () => {
                const {
                    service,
                } =
